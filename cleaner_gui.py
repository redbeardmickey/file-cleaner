...
class cleanerGUI(Frame):
	...
	def scrubFile(self):
		...
		return self.scrubStatusLabelText.set(cleaner.main(self.directory, self.csvfile))
		# pass

	def initUI(self):
		self.parent.title("CleanerGUI")
